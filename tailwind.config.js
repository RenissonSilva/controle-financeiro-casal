    ...
    theme: {
        extend: {
            ...
            colors: {
                ...
                'avatar-bg': themeColor('--color-avatar-bg-rgb'),
                'soft-text': themeColor('--color-soft-text-rgb'),
                ...
                income: themeColor('--color-income-rgb'),
                expense: themeColor('--color-expense-rgb'),
            },
        },
    },
