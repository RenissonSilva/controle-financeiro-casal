...
export default function Dashboard({ month, settings, summary, byCategory, monthlyEvolution, fixedExpenses }) {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold text-gray-800">Dashboard</h2>}>
            ...
            <FixedExpensesPanel fixedExpenses={fixedExpenses} className="mt-6" />
