const INPUT_CLASSES =
    'w-full rounded-[10px] border border-text/16 bg-[#213d51] px-3 py-2 text-[13.5px] text-text placeholder:text-text/40 transition-colors focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent/50';
